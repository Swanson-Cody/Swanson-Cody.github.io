...
weatherObject.open('GET','https://api.wunderground.com/api/1adfc4042a009ff6/conditions/q/TX/Greenville.json', true );
...
weatherForecast.open('GET','https://api.wunderground.com/api/1adfc4042a009ff6/forecast/q/TX/Greenville.json', true );
